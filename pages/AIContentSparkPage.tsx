...
// FIXED:  </label>
 <textarea
// FIXED:  id="userInput"
// FIXED:  value={userInput} />
// FIXED:  onChange={(e) => setUserInput(e.target.value)}
// FIXED:  placeholder="e.g., 'beginner friendly JavaScript tutorials', 'baking sourdough bread for the first time', 'travel vlog Bali'"
 rows={3}
// FIXED:  className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-md shadow-sm focus:ring-sky-500 focus:border-sky-500 bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-50 placeholder-neutral-400 dark:placeholder-neutral-500 text-sm transition-colors"
 />
 <button
// FIXED:  type="submit"
// FIXED:  disabled={isLoading}
// FIXED:  className="mt-4 w-full flex items-center justify-center px-6 py-3 bg-sky-500 hover:bg-sky-600 dark:bg-sky-600 dark:hover:bg-sky-500 text-white font-semibold rounded-lg text-base transition-colors disabled:opacity-70 disabled:cursor-not-allowed" />
 >
 {isLoading ? (
 <>
