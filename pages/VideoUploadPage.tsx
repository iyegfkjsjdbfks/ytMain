...
// FIXED:  className="text-red-600 hover:text-red-700"
 >
 Remove
// FIXED:  </button>
// FIXED:  </div>
...
// FIXED:  className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-gray-700 dark:text-gray-300"
 >
 Upload Thumbnail
// FIXED:  </button>
 )}
...
// FIXED:  className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
...
// FIXED:  className="inline-flex items-center px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full text-sm" />
 ...
 <button
// FIXED:  type="button" />
// FIXED:  onClick={() => handleRemoveTag(tag)}
...
// FIXED:  className="px-6 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
...
// FIXED:  type="submit"
// FIXED:  disabled={progress.status === 'uploading' || progress.status === 'processing'}
// FIXED:  className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" />
 >
