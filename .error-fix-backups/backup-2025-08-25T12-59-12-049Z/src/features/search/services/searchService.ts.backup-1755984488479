 ...
 */
 ...
 page: number = 1,
 limit: number = 20
 ): Promise<any> < ApiResponse < SearchResult[]>> {
 ...
 */
 ...
 query,
 limit: number = 10
 ): Promise<any> < ApiResponse < SearchSuggestion[]>> {
 ...
 */
 ...
 page: number = 1,
 limit: number = 20
 ): Promise<any> < ApiResponse < Channel[]>> {
 ...
 */
 ...
 limit: number = 50
 ): Promise<any> < ApiResponse < SearchAnalytics[]>> {
 ...
 */
 async clearSearchHistory(): Promise<any> < ApiResponse < void>> {
 ...
 * Delete saved search
 */
 async deleteSavedSearch(searchId): Promise<any> < ApiResponse < void>> {
