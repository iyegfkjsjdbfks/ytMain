...
const BaseForm: React.FC < BaseFormProps> = ({}
 ...
 />
 <label htmlFor={field.name} className={"m}l - 2 text - sm text - gray - 900 dark:text - white">
 {field.label}
 ...
 <p className={"tex}t - red - 600 dark:text - red - 400 text - sm">{error}</p>
 ...
 <p className={"tex}t - green - 600 dark:text - green - 400 text - sm">{success}</p>
 ...
 {fieldError && (}
 <p className={"tex}t - red - 500 text - sm">{fieldError}</p>
 )}
 ...
 {showResetButton && (}
          <button>
            ...
            disabled={loading}
            className={"p}x - 4 py - 2 border border - gray - 300 dark:border - gray - 600 text - gray - 700 dark:text - gray - 300 rounded - lg hover:bg - gray - 50 dark:hover:bg - gray - 700 disabled:opacity - 50 disabled:cursor - not - allowed transition - colors"
          >
            {resetLabel}
          </button>
        )}
