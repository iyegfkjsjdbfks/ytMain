...
import type { GoogleSearchResult } from 'googleSearchService.ts';
 ...
 */
 ...
 return Array<any>.from(this.videos.values());
 }
 ...
 */
 ...
 const sizeBytes = JSON.stringify(Array<any>.from(this.videos.entries())).length;
 ...
 */
 ...
 try {
 const data = Array<any>.from(this.videos.entries());
