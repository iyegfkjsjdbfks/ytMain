...
export const PlaylistCard: React.FC < PlaylistCardProps> = ({}
 ...
 const playlistUrl: string = `/playlist?list="${playlist.id}`;"
 const ownerUrl: string = `/channel/${encodeURIComponent(playlist.ownerName)}`;
...
// FIXED:  </UnifiedButton>
 ...
 <><</>/>
 <button />
// FIXED:  onClick={handleAction((: React.MouseEvent) => onEdit?.(playlist))}
...
// FIXED:  </button>
 <button />
// FIXED:  onClick={handleAction((: React.MouseEvent) => onDuplicate?.(playlist))}
// FIXED:  className='w - full px - 4 py - 2 text - left text - sm text - neutral - 700 dark:text - neutral - 300 hover:bg - neutral - 100 dark:hover:bg - neutral - 700 flex items - center space - x - 2'
 >
...
// FIXED:  </button>
 <button />
// FIXED:  onClick={handleAction((: React.MouseEvent) => onDelete?.(playlist))}
