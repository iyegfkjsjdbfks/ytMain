...
export const SubscriptionButton: React.FC < SubscriptionButtonProps> = ({}
 ...
 const handleSubscriptionToggle = async (): Promise<any> < void> => {}
 if (isSubscribed) {}
 await unsubscribe();
 } else {}
 await subscribe();
 ...
 <button />
// FIXED:  onClick={(e: React.MouseEvent) => handleSubscriptionToggle(e)}
...
// FIXED:  className={`${getSizeClasses()} font - medium rounded - full transition - all duration - 200 disabled:opacity - 50 ${}
 ...
 <span className={'m}l - 1 opacity - 75'>
...
// FIXED:  </button>
 ...
 <div className={'p}x - 4 py - 2 text - sm font - medium text - gray - 900 dark:text - white border - b border - gray - 200 dark:border - gray - 700'>
 Notifications
// FIXED:  </div>

 <button />
// FIXED:  onClick={() => handleNotificationChange('all': React.MouseEvent)}
// FIXED:  className={`w - full px - 4 py - 2 text - left text - sm hover:bg - gray - 100 dark:hover:bg - gray - 700 flex items - center gap - 3 ${}
 ...
 <div>
 <div className={'fon}t - medium'>All</div>
<div className={'tex}t - xs opacity - 75'>
...
// FIXED:  </button>
 ...
 <button />
// FIXED:  onClick={() => handleNotificationChange('personalized': React.MouseEvent)}
// FIXED:  className={`w - full px - 4 py - 2 text - left text - sm hover:bg - gray - 100 dark:hover:bg - gray - 700 flex items - center gap - 3 ${}
 ...
 <div>
 <div className={'fon}t - medium'>Personalized</div>
<div className={'tex}t - xs opacity - 75'>
...
// FIXED:  </button>
 ...
 <button />
// FIXED:  onClick={() => handleNotificationChange('none': React.MouseEvent)}
// FIXED:  className={`w - full px - 4 py - 2 text - left text - sm hover:bg - gray - 100 dark:hover:bg - gray - 700 flex items - center gap - 3 ${}
 ...
 <div>
 <div className={'fon}t - medium'>None</div>
<div className={'tex}t - xs opacity - 75'>
