...
// FIXED:  className={"p}x - 3 py - 2 border border - neutral - 300 dark:border - neutral - 600 rounded - lg bg - white dark:bg - neutral - 800 text - neutral - 700 dark:text - neutral - 300 hover:bg - neutral - 50 dark:hover:bg - neutral - 700 transition - colors"
 >
...
// FIXED:  className={"p}x - 3 py - 1 bg - blue - 500 text - white rounded text - sm hover:bg - blue - 600 transition - colors"
 >
...
// FIXED:  className={"p}x - 3 py - 1 bg - purple - 500 text - white rounded text - sm hover:bg - purple - 600 transition - colors"
 >
...
// FIXED:  </div>
 ...
 <div className={"gri}d grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 xl:grid - cols - 4 gap - 6 p - 6">
 {filteredContent.map((item) => (}
 <div key={item.id} className={"grou}p relative">
...
// FIXED:  className={"rounde}d border - neutral - 300 text - blue - 500 focus:ring - blue - 500 bg - white / 90"
 />
// FIXED:  </div>
 <div className={"b}g - neutral - 100 dark:bg - neutral - 700 rounded - lg overflow - hidden hover:shadow - lg transition - shadow">
...
// FIXED:  </div>
 ...
 <h3 className={"fon}t - medium text - neutral - 900 dark:text - neutral - 50 line - clamp - 2 text - sm">
 {item.title}
// FIXED:  </h3>
// FIXED:  </div>
 <div className={"spac}e - y - 2">
 {getStatusBadge(item.status, item.scheduledDate)}
 <div className={"fle}x items - center text - xs text - neutral - 500 dark:text - neutral - 400 space - x - 4">
...
// FIXED:  className="w - 20 h - 12 object - cover rounded" />
 ...
 <h3 className={"fon}t - medium text - neutral - 900 dark:text - neutral - 50 truncate">
 {item.title}
// FIXED:  </h3>
 <div className={"fle}x items - center space - x - 4 mt - 1">
 {getStatusBadge(item.status, item.scheduledDate)}
...
// FIXED:  </div>
 ...
 <div className={"b}g - white dark:bg - neutral - 800 rounded - lg p - 6 w - full max - w - md">
 <h2 className={"tex}t - lg font - semibold text - neutral - 900 dark:text - neutral - 50 mb - 4">
 Schedule Content
// FIXED:  </h2>
 <div className={"spac}e - y - 4">
 <div>
 <label htmlFor="schedule - date" className={"bloc}k text - sm font - medium text - neutral - 700 dark:text - neutral - 300 mb - 2">
 Date
// FIXED:  </label>
 <input>
// FIXED:  type="date"
...
// FIXED:  </div>
 <div>
 <label htmlFor="schedule - time" className={"bloc}k text - sm font - medium text - neutral - 700 dark:text - neutral - 300 mb - 2">
 Time
// FIXED:  </label>
 <input>
// FIXED:  type="time"
...
// FIXED:  </div>
// FIXED:  </div>
 <div className={"fle}x items - center justify - end space - x - 3 mt - 6">
 <button />
// FIXED:  onClick={() => setShowScheduleModal(false: React.MouseEvent)}
// FIXED:  className={"p}x - 4 py - 2 text - neutral - 700 dark:text - neutral - 300 hover:bg - neutral - 100 dark:hover:bg - neutral - 700 rounded - lg transition - colors"
 >
 Cancel
// FIXED:  </button>
 <button />
...
// FIXED:  className={"p}x - 4 py - 2 bg - blue - 500 text - white rounded - lg hover:bg - blue - 600 disabled:opacity - 50 disabled:cursor - not - allowed transition - colors"
 >
 Schedule
// FIXED:  </button>
// FIXED:  </div>
