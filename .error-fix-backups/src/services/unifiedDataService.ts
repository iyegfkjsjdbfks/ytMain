...
import { metadataNormalizationService, type UnifiedVideoMetadata, type UnifiedChannelMetadata } from 'metadataNormalizationService.ts';
 ...
 */
 ...
 ): Promise<any> < UnifiedDataResponse < UnifiedVideoMetadata>> {
 ...
 const results = await Promise<any>.allSettled([
 ...
 */
 async getVideoById(id): Promise<any> < UnifiedVideoMetadata | null> {
 ...
 */
 async getChannelById(id): Promise<any> < UnifiedChannelMetadata | null> {
 ...
 */
 ...
 private async fetchLocalTrendingVideos(
  ...
  ): Promise<any> < UnifiedVideoMetadata[]> {
 ...
 */
 ...
 const allVideos: any[] = [...localVideos as any, ...youtubeVideos];
