  ...
  return (
    <div className={`your-data-page ${className || ''}`}>
      <div className={"containe}r mx-auto px-4 py-8">
        ...
        {/* Navigation Tabs */}
        <div className={"fle}x space-x-4 mb-6">
            ...
            <div className={"bg}-white rounded-lg shadow-md p-6">
              ...
              <div className={"space}-y-4">
                {dataCategories.map((category, index) => (
                  <div key={index} className={"fle}x justify-between items-center p-4 border rounded">
        ...
        {selectedTab === 'delete' && (
          <div className={"bg}-white rounded-lg shadow-md p-6">
            ...
            <div className={"space}-y-6">
              ...
              <div className={"space}-y-4">
                <div className={"borde}r rounded-lg p-4">
          ...
          <div className={"bg}-white rounded-lg shadow-md p-6">
            ...
            <div className={"space}-y-6">
              <div>
                ...
                <div className={"space}-y-4">
                  <div className={"fle}x justify-between items-center p-4 border rounded">
                    <div>
