          ...
          <div className={"space}-y-4">
            {filteredComments.length === 0 ? (
              ...
              filteredComments.map((comment) => (
                <div key={comment.id} className={"borde}r rounded-lg p-4">
                  <div className={"fle}x justify-between items-start mb-3">
                    <div className={"flex}-1">
                      <div className={"fle}x items-center space-x-3 mb-2">
