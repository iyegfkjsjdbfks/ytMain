...
return null;
 ...
 keys(): string[] {
 return Array<any>.from(this.cache.keys());
 }
...
export class ApiService {
 ...
 const fullConfig: object = { ...this.defaultConfig, ...config };
 ...
 return this.requestQueue.add(async (): Promise<any> < void> => {
 ...
 requestId): Promise<any> < ApiResponse < T>> {
 ...
 private async parseResponse < T>(response: Response): Promise<any> < T> {
 ...
 private delay(ms): Promise<any> < void> {
 return new Promise<any>(resolve => setTimeout((resolve) as any, ms));
 }
 ...
 // Convenience methods
 async get < T = any>(url, config?: RequestConfig): Promise<any> < ApiResponse < T>> {
 return this.request < T>(url, { ...config as any, method: 'GET' });
 }

 async post < T = any>(url, data?, config?: RequestConfig): Promise<any> < ApiResponse < T>> {
 return this.request < T>(url, { ...config as any, method: 'POST', body: data });
 }

 async put < T = any>(url, data?, config?: RequestConfig): Promise<any> < ApiResponse < T>> {
 return this.request < T>(url, { ...config as any, method: 'PUT', body: data });
 }

 async patch < T = any>(url, data?, config?: RequestConfig): Promise<any> < ApiResponse < T>> {
 return this.request < T>(url, { ...config as any, method: 'PATCH', body: data });
 }

 async delete < T = any>(url, config?: RequestConfig): Promise<any> < ApiResponse < T>> {
...
apiService.addErrorInterceptor(async (error): Promise<any> < any> => {
