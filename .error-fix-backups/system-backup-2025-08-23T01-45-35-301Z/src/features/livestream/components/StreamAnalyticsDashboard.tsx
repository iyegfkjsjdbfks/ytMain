...
const StatsCard: FC < StatsCardProps> = ({}
 ...
 subtitle,
 trend }) => (
 <div className={'b}g - white dark:bg - gray - 800 p - 4 rounded - lg shadow border border - gray - 200 dark:border - gray - 700 hover:shadow - md transition - shadow'>
 <div className={'fle}x items - center justify - between'>
 <div className={'fle}x - 1'>
 <p className={'tex}t - sm text - gray - 600 dark:text - gray - 400 font - medium'>
 {title}
// FIXED:  </p>
...
// FIXED:  </p>
// FIXED:  </div>
<div className={'fle}x - shrink - 0 ml - 4'>{icon}</div>
// FIXED:  </div>
 {(subtitle || trend) && (}
 <div className={'m}t - 3 flex items - center text - sm'>
 {trend}
 {subtitle && (}
 <span className={'tex}t - gray - 600 dark:text - gray - 400'>{subtitle}</span>
 )}
// FIXED:  </div>
 )}
// FIXED:  </div>
...
const TopMoments: React.FC < TopMomentsProps> = ({ moments }: any) => {}
 ...
 if (moments.length === 0) {}
 return (
 <div className={'b}g - white dark:bg - gray - 800 p - 6 rounded - lg shadow border border - gray - 200 dark:border - gray - 700'>
 <h3 className={'tex}t - lg font - semibold text - gray - 900 dark:text - white mb - 4'>
 Top Moments
// FIXED:  </h3>
 <div className={'tex}t - center text - gray - 500 dark:text - gray - 400 py - 8'>
...
// FIXED:  </div>
// FIXED:  </div>
<div className={'tex}t - sm font - bold text - gray - 900 dark:text - white'>
...
// FIXED:  className={'fle}x items - center justify - between'/>
 <span className={'tex}t - sm text - gray - 600 dark:text - gray - 400 font - medium'>
 {country.name}
// FIXED:  </span>
 <div className={'fle}x items - center space - x-3'>
...
// FIXED:  style={{ width: `${country.percentage}%` } />
 />
// FIXED:  </div>
<span className={'tex}t - sm font - medium text - gray - 900 dark:text - white min - w-[2rem] text - right'>
 {country.percentage}%
// FIXED:  </span>
// FIXED:  </div>
// FIXED:  </div>
...
// FIXED:  className={'tex}t - center p - 3 bg - gray - 50 dark:bg - gray - 700 rounded - lg hover:bg - gray - 100 dark:hover:bg - gray - 600 transition - colors'/>
 <div className={'tex}t - lg font - bold text - gray - 900 dark:text - white'>
 {device.percentage}%
// FIXED:  </div>
<div className={'tex}t - xs text - gray - 600 dark:text - gray - 400 font - medium'>
 {device.type}
// FIXED:  </div>
// FIXED:  </div>
 ))}
...
// FIXED:  </div>
 ...
 return (
 <div className={`p - 6 ${className}`}>
 <div className={'tex}t - center text - gray - 500 dark:text - gray - 400'>
 <ChartBarIcon className='h - 12 w - 12 mx - auto mb - 4 text - gray - 400 dark:text - gray - 500' />
 <h3 className={'tex}t - lg font - medium mb - 2'>
 No analytics data available
// FIXED:  </h3>
 <p className={'tex}t - sm'>
...
// FIXED:  className={'p}x - 3 py - 2 border border - gray - 300 dark:border - gray - 600 rounded - md text - sm focus:outline - none focus:ring - 2 focus:ring - blue - 500 bg - white dark:bg - gray - 700 text - gray - 900 dark:text - white'
...
// FIXED:  value={analytics.realTimeStats.viewers} />
 ...
 <span className={'tex}t - green - 600'>,
...
// FIXED:  className={'p}x - 3 py - 1 border border - gray - 300 dark:border - gray - 600 rounded text - sm focus:outline - none focus:ring - 2 focus:ring - blue - 500 bg - white dark:bg - gray - 700 text - gray - 900 dark:text - white'
...
// FIXED:  aria - label={`${selectedMetric} chart`}/>
 ...
 <div>
 key={point.id}
// FIXED:  className={'b}g - blue - 500 rounded - t hover:bg - blue - 600 transition - colors cursor - pointer'
