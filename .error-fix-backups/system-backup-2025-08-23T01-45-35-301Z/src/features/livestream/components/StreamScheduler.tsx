...
// FIXED:  className={`bg - white border border - gray - 200 rounded - lg p - 4 ${className}`}/>
 ...
 <span className={'fon}t - medium text - gray - 900'>Stream Scheduler</span>
...
// FIXED:  className={'m}b - 6 p - 4 bg - gray - 50 rounded - lg border'
 >
...
// FIXED:  className={'bloc}k text - sm font - medium text - gray - 700 mb - 1'/>
 Tags
// FIXED:  </label>
 <div className={'fle}x space - x-2 mb - 2'>
 <input>
...
// FIXED:  className={'p}x - 3 py - 2 bg - gray - 600 text - white rounded - lg hover:bg - gray - 700'
 >
 Add
// FIXED:  </button>
// FIXED:  </div>
 ...
 <span>
 key={tag}
// FIXED:  className={'inlin}e - flex items - center px - 2 py - 1 bg - blue - 100 text - blue - 800 text - sm rounded - lg'/>
 {tag}
 <button>
// FIXED:  type='button' />
// FIXED:  onClick={() => removeTag(tag: React.MouseEvent)}
// FIXED:  className={'m}l - 1 text - blue - 600 hover:text - blue - 800'
 >
 ×
// FIXED:  </button>
// FIXED:  </span>
...
// FIXED:  </div>
 ...
 <div className={'fle}x space - x-2 mt - 4'>
 <button>
// FIXED:  type='submit'
...
// FIXED:  className='p - 4 border border - gray - 200 rounded - lg hover:bg - gray - 50 transition - colors'/>
 ...
 <h3 className={'fon}t - medium text - gray - 900'>
 {stream.title}
// FIXED:  </h3>
 <span>
...
// FIXED:  </p>
 ...
 <div className={'fle}x items - center space - x-4 text - sm text - gray - 500'>
...
<span>•</span>
 ...
 <span>•</span>
 <span className={'fon}t - medium text - blue - 600'>
 {stream.scheduledStartTime &&}
...
// FIXED:  </div>
 ...
 <span>
 key={tag}
// FIXED:  className={'p}x - 2 py - 1 bg - gray - 100 text - gray - 600 text - xs rounded'/>
 {tag}
// FIXED:  </span>
 ))}
 {stream.tags.length > 3 && (}
 <span className={'p}x - 2 py - 1 bg - gray - 100 text - gray - 600 text - xs rounded'>
...
// FIXED:  className={'fle}x items - center space - x-1 px - 3 py - 1 bg - green - 600 text - white rounded - lg hover:bg - green - 700 text - sm'
 >
