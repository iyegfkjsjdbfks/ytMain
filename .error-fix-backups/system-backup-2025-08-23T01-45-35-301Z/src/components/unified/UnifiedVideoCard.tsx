...
import { UnifiedButton } from 'UnifiedButton.tsx';
...
// FIXED:  </div>
 ...
 variant='ghost'
 size='xs' />
// FIXED:  onClick={(e: React.MouseEvent) => handleLike(e)}
...
// FIXED:  </div>
 ...
 <Link>
 to={channelUrl} />
// FIXED:  onClick={(e: React.MouseEvent) => handleChannelClick(e)}
...
// FIXED:  </Link>
 ...
 {/* Video Info */}
 <div className={'fle}x - 1 min - w-0 space - y-1'>
 {/* Title */}
