...
const LoadingSkeleton = memo(() => (
 <div className={"mi}n - h-screen bg - white dark:bg - gray - 900">
 <div className={"ma}x - w-[1280px] mx - auto px - 4 py - 4">
 <div className={"fle}x flex - col xl:flex - row gap - 6">
 <div className={"fle}x - 1 max - w-full xl:max - w-[854px]">
 {/* Video player skeleton */}
 <div className={"aspec}t - video bg - gray - 200 dark:bg - gray - 700 rounded - xl animate - pulse mb - 4" />
...
// FIXED:  </div>
 ...
 <div className={"b}g - gray - 200 dark:bg - gray - 700 rounded - xl p - 4 mb - 4 animate - pulse">
...
const WatchPage: React.FC = () => {}
 ...
 if (!video) {}
 return (
 <div className={"mi}n - h-screen bg - white dark:bg - gray - 900 flex items - center justify - center">
 <div className={"tex}t - center">
 <h1 className={"tex}t - 2xl font - bold text - gray - 900 dark:text - white mb - 2">Video not found</h1>
 <p className={"tex}t - gray - 600 dark:text - gray - 400 mb - 4">The video you're looking for doesn't exist or has been removed.</p>
 <button />
// FIXED:  onClick={() => navigate('/': React.MouseEvent)}
// FIXED:  className={"b}g - red - 600 text - white px - 4 py - 2 rounded - lg hover:bg - red - 700 transition - colors"
 >
 Go to Home
// FIXED:  </button>
// FIXED:  </div>
// FIXED:  </div>
 ...
 return (
 <div className={"mi}n - h-screen bg - white dark:bg - gray - 900">
 <div className={"ma}x - w-[1280px] mx - auto px - 2 sm:px - 4 py - 2 sm:py - 4">
 <div className={"fle}x flex - col xl:flex - row gap - 3 sm:gap - 6">
 {/* Main content - Video player and details */}
 <div className={"fle}x - 1 max - w-full xl:max - w-[854px]">
 {/* Video player container */}
 <div className={"relativ}e w - full mb - 3 sm:mb - 4">
 <div className={"aspec}t - video bg - black rounded - lg sm:rounded - xl overflow - hidden">
...
// FIXED:  </div>
 ...
 {/* Video title */}
 <div className={"m}b - 2 sm:mb - 3 px - 1 sm:px - 0">
 <h1 className={"tex}t - lg sm:text - xl font - bold text - gray - 900 dark:text - white leading - tight">
 {video.title}
// FIXED:  </h1>
// FIXED:  </div>
 ...
 <div className={"tex}t - xs sm:text - sm text - gray - 600 dark:text - gray - 400">
...
// FIXED:  </div>
 ...
 <h2 className={"tex}t - lg font - semibold text - gray - 900 dark:text - white mb - 3 px - 1 sm:px - 0">Up next</h2>
