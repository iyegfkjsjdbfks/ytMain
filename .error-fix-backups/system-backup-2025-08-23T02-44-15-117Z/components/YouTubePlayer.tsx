...
const YouTubePlayer: React.FC < YouTubePlayerProps> = ({}
 ...
 if (document.querySelector('script[src*="youtube.com / iframe_api"]') as HTMLElement as HTMLElement as HTMLElement) {}
...
return;
 ...
 const container = document.getElementById(playerIdRef.current) as HTMLElement as HTMLElement as HTMLElement;
