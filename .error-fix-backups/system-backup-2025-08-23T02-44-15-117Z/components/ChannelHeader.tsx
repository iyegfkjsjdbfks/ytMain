...
const ChannelHeader: React.FC < ChannelHeaderProps> = ({}
 ...
 <img />
 <div className={"p}x - 4 md:px - 6 lg:px - 8">
 ...
 />
 <div className={"fle}x - grow mt - 3 sm:mt - 0 text - center sm:text - left">
 <h1 className={"tex}t - 2xl sm:text - 3xl md:text - 4xl font - bold text - neutral - 900 dark:text - neutral - 50">{((channel.name || channel.title) || channel.title)}</h1>
 ...
 <div className={"m}t - 4 sm:mt - 0 sm:ml - auto flex - shrink - 0">
 <button />
 ${isSubscribed}
