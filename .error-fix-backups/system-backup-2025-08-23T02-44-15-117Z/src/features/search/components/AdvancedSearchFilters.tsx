...
export const AdvancedSearchFilters: React.FC < AdvancedSearchFiltersProps> = ({}
 ...
 <button />
// FIXED:  onClick={(e: React.MouseEvent) => onToggle(e)}
// FIXED:  className={'fle}x items - center gap - 2 px - 4 py - 2 border border - gray - 300 dark:border - gray - 600 rounded - lg hover:bg - gray - 50 dark:hover:bg - gray - 800 transition - colors'
 ...
 <span > Filters</span>
 {hasActiveFilters() && (}
 <span className={'b}g - blue - 600 text - white text - xs px - 2 py - 0.5 rounded - full'>
...
// FIXED:  </h3>
 ...
 {hasActiveFilters() && (}
 <button />
// FIXED:  onClick={(e: React.MouseEvent) => resetFilters(e)}
...
// FIXED:  className={'tex}t - blue - 600'
 />
...
// FIXED:  onChange={() => toggleFeature(value: React.ChangeEvent)}
// FIXED:  className={'tex}t - blue - 600'
 />
 <span className={'tex}t - sm text - gray - 700 dark:text - gray - 300'>
 {label}
...
// FIXED:  </div>
 ...
 <button />
// FIXED:  onClick={(e: React.MouseEvent) => onToggle(e)}
// FIXED:  className={'p}x - 6 py - 2 bg - blue - 600 text - white rounded - lg hover:bg - blue - 700 transition - colors'
 >
 Apply Filters
// FIXED:  </button>
// FIXED:  </div>
