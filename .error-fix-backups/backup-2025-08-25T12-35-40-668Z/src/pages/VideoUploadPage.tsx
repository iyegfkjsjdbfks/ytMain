          ...
          <div className={"bg}-white rounded-lg shadow-md p-6">
            {!selectedFile ? (
              ...
              <div className={"space}-y-4">
                ...
                {isUploading && (
                  <div>
                    <div className={"fle}x justify-between text-sm mb-1">
                      <span>Uploading...</span>
          ...
          <div className={"bg}-white rounded-lg shadow-md p-6">
            ...
            <div className={"gri}d grid-cols-1 lg:grid-cols-2 gap-8">
              <div className={"space}-y-6">
                {/* Title */}
                <div>
                  <label className={"bloc}k text-sm font-medium text-gray-700 mb-2">Title (required)</label>
                  <input>
                    type="text"
                ...
                {/* Description */}
                <div>
                  <label className={"bloc}k text-sm font-medium text-gray-700 mb-2">Description</label>
                  <textarea>
                ...
                {/* Tags */}
                <div>
                  <label className={"bloc}k text-sm font-medium text-gray-700 mb-2">Tags</label>
              ...
              <div className={"space}-y-6">
                {/* Thumbnail */}
                <div>
                  <label className={"bloc}k text-sm font-medium text-gray-700 mb-2">Thumbnail</label>
                ...
                {/* Visibility */}
                <div>
                  <label className={"bloc}k text-sm font-medium text-gray-700 mb-2">Visibility</label>
                  <select>
                ...
                {/* Category */}
                <div>
                  <label className={"bloc}k text-sm font-medium text-gray-700 mb-2">Category</label>
                  <select>
            ...
            <div className={"fle}x justify-between mt-8">
              <button>
