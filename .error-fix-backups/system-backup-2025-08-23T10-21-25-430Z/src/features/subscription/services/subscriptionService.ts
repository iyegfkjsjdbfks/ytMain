 ...
 */
 async getSubscriptionStatus(channelId): Promise<any> < Subscription | null> {
 try {
 ...
 */
 async subscribe(channelId): Promise<any> < ApiResponse < Subscription>> {
 ...
 */
 async unsubscribe(channelId): Promise<any> < ApiResponse < void>> {
 ...
 */
 ...
 ): Promise<any> < ApiResponse < Subscription>> {
 ...
 */
 async getSubscriptionStats(): Promise<any> < SubscriptionStats> {
 try {
 ...
 */
 async exportSubscriptions(format: 'json' | 'csv' | 'opml'): Promise<any> < string> {
 try {
