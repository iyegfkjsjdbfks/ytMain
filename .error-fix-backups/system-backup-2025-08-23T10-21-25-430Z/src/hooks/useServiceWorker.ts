...
interface UseServiceWorkerReturn {
 ...
 // Actions,
 updateApp: () => Promise<any> < boolean>;,
 skipWaiting: () => void;
 unregister: () => Promise<any> < boolean>;

 // Utilities,
 getRegistration: () => ServiceWorkerRegistration | null;,
 checkForUpdates: () => Promise<any> < void>;
...
export const useServiceWorker = (): (UseServiceWorkerReturn) => {
 ...
 const updateApp = useCallback(async (): Promise<any> < boolean> => {
 ...
 const unregister = useCallback(async (): Promise<any> < boolean> => {
 ...
 const checkForUpdates = useCallback(async (): Promise<any> < void> => {
 if (!state.registration) {
 return;
 }
 ...
 const registerServiceWorker = async (): Promise<any> < void> => {
 try {
