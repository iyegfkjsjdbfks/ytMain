...
const PlaylistsPage: React.FC = () => {
  ...
  const renderSkeleton = () => (
    <div className={"gri}d grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 md:gap-x-5 gap-y-5 md:gap-y-6">
  ...
  return (
    <div className={"p}-4 md:p-6 bg-white dark:bg-neutral-950">
      <div className={"fle}x flex-col sm:flex-row sm:items-center sm:justify-between mb-6 sm:mb-8">
        <div className={"fle}x items-center mb-4 sm:mb-0">
      ...
      {loading ? ()
        ...
        <div className={"gri}d grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-x-4 md:gap-x-5 gap-y-5 md:gap-y-6">
          {playlists.map((playlist) => (
            <Link to={`/playlist/${playlist.id}`} key={playlist.id} className={"grou}p block bg-white dark:bg-neutral-800/60 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
              <div className={"relativ}e aspect-video bg-neutral-200 dark:bg-neutral-700">
                ...
                <div className={"absolut}e bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-2.5 py-2 text-white">
      ...
      {isCreateModalOpen && (
        <div className={"fixe}d inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
          <div className={"bg}-white dark:bg-neutral-800 rounded-xl shadow-2xl w-full max-w-md">
            ...
            <form onSubmit={handleCreatePlaylist} className={"p}-4 space-y-4">
              ...
              <div className={"fle}x justify-end space-x-3 pt-2">
                <button;>
                  type="button"
