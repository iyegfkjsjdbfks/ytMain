  ...
  return (
    <div className={`analytics-page ${className || ''}`}>
      <div className={"containe}r mx-auto px-4 py-8">
        <div className={"fle}x justify-between items-center mb-6">
          ...
          <div className={"bg}-white rounded-lg shadow-md p-6">
            ...
            <div className={"space}-y-4">
              {[
                ...
                <div key={index} className={"fle}x items-center space-x-3">
          ...
          <div className={"bg}-white rounded-lg shadow-md p-6">
            ...
            <div className={"space}-y-4">
              {topVideos.map((video, index) => (
                <div key={index} className={"fle}x justify-between items-center p-3 border rounded">
          ...
          <div className={"bg}-white rounded-lg shadow-md p-6">
            ...
            <div className={"space}-y-4">
              {audienceData.map((country, index) => (
                <div key={index} className={"fle}x justify-between items-center">
