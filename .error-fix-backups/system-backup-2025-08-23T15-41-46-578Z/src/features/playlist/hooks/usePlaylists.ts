...
export function usePlaylistVideos(: string | number, ;
 playlistId: string | number, page: number = 1, limit: number = 50): any {
 return useQuery(
...
export function useSearchPlaylists(: any, ;
 query: any, filters: Omit < PlaylistFilters, 'search'> = {}): any {
 return useQuery(
