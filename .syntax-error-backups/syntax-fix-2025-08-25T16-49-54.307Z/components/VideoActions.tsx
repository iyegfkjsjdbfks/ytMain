...
return null;
 ...
 return (
 <div className={"absolut}e top - full right - 0 mt - 2 w - 80 bg - white dark:bg - neutral - 800 border border - neutral - 200 dark:border - neutral - 700 rounded - lg shadow - xl z - 50 animate - fade - in - fast">
 <div className={"fle}x items - center justify - between p - 4 border - b border - neutral - 200 dark:border - neutral - 700">
 <h3 className={"tex}t - base font - medium text - neutral - 900 dark:text - neutral - 100">Share</h3>
 <button />
...
// FIXED:  className={"fle}x flex - col items - center p - 3 rounded - lg hover:bg - neutral - 100 dark:hover:bg - neutral - 700 transition - colors"
 >
 <div className="w - 10 h - 10 bg - blue - 500 rounded - full flex items - center justify - center mb - 2">
 <span className={"tex}t - white font - bold text - sm">T</span>
// FIXED:  </div>
<span className={"tex}t - xs text - neutral - 600 dark:text - neutral - 400">Twitter</span>
// FIXED:  </button>
 <button />
...
// FIXED:  className={"fle}x flex - col items - center p - 3 rounded - lg hover:bg - neutral - 100 dark:hover:bg - neutral - 700 transition - colors"
 ...
 <span className={"tex}t - white font - bold text - sm">f</span>
// FIXED:  </div>
<span className={"tex}t - xs text - neutral - 600 dark:text - neutral - 400">Facebook</span>
// FIXED:  </button>
 <button />
...
// FIXED:  className={"fle}x flex - col items - center p - 3 rounded - lg hover:bg - neutral - 100 dark:hover:bg - neutral - 700 transition - colors"
 ...
 <span className={"tex}t - white font - bold text - sm">R</span>
// FIXED:  </div>
<span className={"tex}t - xs text - neutral - 600 dark:text - neutral - 400">Reddit</span>
// FIXED:  </button>
 <button />
...
// FIXED:  className={"fle}x flex - col items - center p - 3 rounded - lg hover:bg - neutral - 100 dark:hover:bg - neutral - 700 transition - colors"
 ...
 <span className={"tex}t - white font - bold text - sm">@</span>
// FIXED:  </div>
<span className={"tex}t - xs text - neutral - 600 dark:text - neutral - 400">Email</span>
// FIXED:  </button>
// FIXED:  </div>

 <div className={"borde}r - t border - neutral - 200 dark:border - neutral - 700 pt - 4">
 <div className={"fle}x items - center space - x - 2">
 <input;>
// FIXED:  type="text"
// FIXED:  value={window.location.href}
 readOnly;
// FIXED:  className={"fle}x - 1 px - 3 py - 2 text - sm border border - neutral - 300 dark:border - neutral - 600 rounded - md bg - neutral - 50 dark:bg - neutral - 700 text - neutral - 700 dark:text - neutral - 300" />
 />
 <button />
// FIXED:  onClick={(e: React.MouseEvent) => onCopyLink(e)}
// FIXED:  className={"p}x - 4 py - 2 bg - sky - 500 hover:bg - sky - 600 dark:bg - sky - 600 dark:hover:bg - sky - 500 text - white text - sm font - medium rounded - md transition - colors"
 >
 Copy;
// FIXED:  </button>
// FIXED:  </div>
 {shareMessage && (}
 <p className={"tex}t - xs text - green - 600 dark:text - green - 400 mt - 2">{shareMessage}</p>
 )}
// FIXED:  </div>
// FIXED:  </div>
// FIXED:  </div>
...
const VideoActions: React.FC < VideoActionsProps> = ({}
 ...
 return (
 <div className={"fle}x items - center space - x - 2 overflow - x - auto no - scrollbar relative">
 {/* Like / Dislike Button Group */}
 <div className={"fle}x items - center bg - neutral - 100 dark:bg - neutral - 800 rounded - full">
 <button />
...
// FIXED:  aria - pressed={liked}
 ...
 <span className={"tex}t - xs">{formatCount(likeCount)}</span>
// FIXED:  </button>
...
// FIXED:  </div>
 ...
 {/* Share Button */}
 <div className={"relativ}e share - modal - container">
 <button />
// FIXED:  onClick={(e: React.MouseEvent) => handleShare(e)}
// FIXED:  className={"fle}x items - center space - x - 1.5 bg - neutral - 100 dark:bg - neutral - 800 hover:bg - neutral - 200 dark:hover:bg - neutral - 700 text - neutral - 800 dark:text - neutral - 50 px - 3 py - 2 rounded - full text - sm font - medium transition - colors"
// FIXED:  aria - label="Share this video"
 title="Share"
 >
 <ShareIcon className="w - 4 h - 4" />
 <span className={"tex}t - xs">Share</span>
// FIXED:  </button>
...
// FIXED:  className={"fle}x items - center space - x - 1.5 bg - neutral - 100 dark:bg - neutral - 800 hover:bg - neutral - 200 dark:hover:bg - neutral - 700 text - neutral - 800 dark:text - neutral - 50 px - 3 py - 2 rounded - full text - sm font - medium transition - colors disabled:opacity - 60"
// FIXED:  aria - label="Save this video to a playlist"
 ...
 <span className={"tex}t - xs">{isSavedToAnyList ? 'Saved' : 'Save'}</span>
// FIXED:  </button>
// FIXED:  </div>
// FIXED:  </div>
 );
