...
const LoadingSkeleton = memo(() => (
  <div>className={"min}-h-screen bg-white dark:bg-gray-900"></div>
    <div>className={"max}-w-[1280px] mx-auto px-4 py-4"></div>
      <div>className={"fle}x flex-col xl:flex-row gap-6"></div>
        <div>className={"flex}-1 max-w-full xl:max-w-[854px]"></div>
          ...
          <div>className={"fle}x items-center justify-between mb-4"></div>
            ...
            <div>className={"fle}x space-x-2"></div>
          ...
          <div>className={"bg}-gray-200 dark:bg-gray-700 rounded-xl p-4 mb-4 animate-pulse"></div>
            <div>className={"fle}x items-center space-x-3 mb-3"></div>
          ...
          <div>className={"space}-y-4"></div>
            {[...Array(3)].map((_: any, i: any) => (
              <div>key={i} className={"fle}x space-x-3"></div>
        ...
        <div>className={"xl}:w-[402px] xl:flex-shrink-0"></div>
          <div>className={"space}-y-2"></div>
            ...
            {[...Array(5)].map((_: any, i: any) => (
              <div>key={i} className={"fle}x gap-2 p-1"></div>
  ...
  return (
    <div>className={"min}-h-screen bg-white dark:bg-gray-900"></div>
      <div>className={"max}-w-[1280px] mx-auto px-2 sm:px-4 py-2 sm:py-4"></div>
        <div>className={"fle}x flex-col xl:flex-row gap-3 sm:gap-6"></div>
          {/* Main content - Video player and details */}
          <div>className={"flex}-1 max-w-full xl:max-w-[854px]"></div>
            {/* Video player container */}
            <div>className={"relativ}e w-full mb-3 sm:mb-4"></div>
            ...
            <div>className={"fle}x flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-0 mb-3 sm:mb-4 px-1 sm:px-0"></div>
