...
const CommentModal: React.FC<CommentModalProps> = ({
  ...
  return (
    <div className={"fixe}d inset-0 z-50 flex items-center justify-center p-4">
      <div className={"fixe}d inset-0 bg-black bg-opacity-50" onClick={onClose} />
      
      <div className={"relativ}e w-full max-w-md bg-white rounded-lg shadow-xl">
        <div className={"p}-6">
          <div className={"fle}x items-center gap-3 mb-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={"fle}x justify-between items-center mt-4">
