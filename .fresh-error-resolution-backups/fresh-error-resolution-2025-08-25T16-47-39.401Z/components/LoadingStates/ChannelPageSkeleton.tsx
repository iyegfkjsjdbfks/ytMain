...
const ChannelPageSkeleton: React.FC = () => {
 ...
 <div className={"fle}x flex-col sm:flex-row items-center sm:items-end -mt-10 sm:-mt-12 md:-mt-16 mb-4 relative z-10">
...
// FIXED:  </div>
 <div className={"fle}x border-b border-neutral-300 dark:border-neutral-700 space-x-1 mb-4">
...
// FIXED:  </div>
 ...
 <div className={"gri}d grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
