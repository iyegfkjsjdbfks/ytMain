...
const OptimizedSearchResults: React.FC<OptimizedSearchResultsProps> = ({ query, onResultSelect }) => {
  ...
  if (loading) {
    return (
      <div className={"fle}x items-center justify-center py-8">
  ...
  return (
    <div className={"space}-y-4">
      {results.map((result) => (
        <div>
          key={result.id}
          className={"fle}x gap-4 p-4 hover:bg-gray-50 rounded-lg cursor-pointer"
          ...
          {result.type === 'video' ? (
            <>
              ...
              <div className={"flex}-1">
                ...
                <div className={"fle}x items-center gap-2 text-sm text-gray-500">
