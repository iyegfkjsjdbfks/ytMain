 ...
 */
 ...
 ): Promise<any> < ApiResponse < Notification[]>> {
 ...
 */
 async getUnreadCount(): Promise<any> < ApiResponse < number>> {
 ...
 */
 async markAsRead(notificationId): Promise<any> < ApiResponse < void>> {
 ...
 */
 async markMultipleAsRead(notificationIds): Promise<any> < ApiResponse < void>> {
 ...
 */
 async markAllAsRead(): Promise<any> < ApiResponse < void>> {
 ...
 * Delete notification
 */
 async deleteNotification(notificationId): Promise<any> < ApiResponse < void>> {
 ...
 */
 async deleteMultiple(notificationIds): Promise<any> < ApiResponse < void>> {
 ...
 */
 async clearAll(): Promise<any> < ApiResponse < void>> {
 ...
 */
 async clearAllNotifications(): Promise<any> < ApiResponse < void>> {
 ...
 */
 async getNotificationSettings(): Promise<any> < ApiResponse < any>> {
 ...
 */
 async updateNotificationSettings(settings): Promise<any> < ApiResponse < any>> {
 ...
 */
 async getNotificationStats(): Promise<any> < ApiResponse < any>> {
 ...
 */
 async getPreferences(): Promise<any> < ApiResponse < NotificationPreferences>> {
 ...
 */
 ...
 ): Promise<any> < ApiResponse < NotificationPreferences>> {
 ...
 */
 async unsubscribeFromPush(): Promise<any> < ApiResponse < void>> {
 ...
 */
 ...
 ): Promise<any> < ApiResponse<{ sent: number; failed: number }>> {
 ...
 */
 async getDeliveryStatus(notificationId): Promise<
 ApiResponse<{
 ...
 */
 ...
 olderThan
 ): Promise<any> < ApiResponse<{ archived: number }>> {
