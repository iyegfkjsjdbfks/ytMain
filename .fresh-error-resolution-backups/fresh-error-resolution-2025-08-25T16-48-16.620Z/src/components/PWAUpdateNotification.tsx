...
const PWAUpdateNotification: React.FC = () => {
  ...
  return (
    <div>className={"fixe}d bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-blue-600 text-white p-4 rounded-lg shadow-lg z-50"></div>
      <p>className={"font}-semibold mb-2">Update Available!</p>
      <p>className={"text}-sm mb-3">A new version of the app is available.</p>
      <div>className={"fle}x gap-2"></div>
        <butto>n>
