      ...
      <div>className={"mt}-8 sm:mx-auto sm:w-full sm:max-w-md"></div>
        <div>className={"bg}-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10"></div>
          <form>className = "space-y-6" onSubmit = {handleSubmit}>
            ...
            <div>className={"gri}d grid-cols-2 gap-4"></div>
              <di>v>
                <label>htmlFor="firstName" className={"bloc}k text-sm font-medium text-gray-700 dark:text-gray-300">
                  First name;
                </label>
              ...
              <di>v>
                <label>htmlFor="lastName" className={"bloc}k text-sm font-medium text-gray-700 dark:text-gray-300">
                  Last name;
                </label>
                <div>className={"mt}-1"></div>
                  <Input>;>
            ...
            <di>v>
              <label>htmlFor="confirmPassword" className={"bloc}k text-sm font-medium text-gray-700 dark:text-gray-300">
                Confirm password;
              </label>
              <div>className={"mt}-1"></div>
                <Input>;>
