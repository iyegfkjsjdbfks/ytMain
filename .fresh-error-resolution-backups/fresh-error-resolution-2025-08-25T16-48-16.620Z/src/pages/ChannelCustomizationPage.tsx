          ...
          {activeTab === 'branding' && (
            <di>v>
              ...
              <div>className={"space}-y-6"></div>
                <di>v>
                  <label>className={"bloc}k text-sm font-medium text-gray-700 mb-2">
                    Channel Icon;
                  </label>
              ...
              <div>className={"space}-y-6"></div>
                ...
                <di>v>
                  ...
                  <div>className={"space}-y-2"></div>
                    <div>className={"fle}x items-center justify-between p-3 border rounded"></div>
