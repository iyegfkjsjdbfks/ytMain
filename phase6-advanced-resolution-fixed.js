...
ction createAuthComponentTemplate(fileName) {
...
function createAuthServiceTemplate(fileName) {
...
createCommentComponentTemplate(fileName) {
...
function createCommentHookTemplate(fileName) {
...
reateErrorBoundaryTemplate(fileName) {
...
nction createAdvancedComponentTemplate(fileName) {
