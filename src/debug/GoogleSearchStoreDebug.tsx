    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg mb-6">
        ...
        <div className="space-y-1 text-sm">
          <div>Google Search API Key: {import.meta.env.VITE_GOOGLE_SEARCH_API_KEY ? '✅ Set' : '❌ Missing'}</div>
          <div>Google Search Engine ID: {import.meta.env.VITE_GOOGLE_SEARCH_ENGINE_ID ? '✅ Set' : '❌ Missing'}</div>
          <div>YouTube API Key: {import.meta.env.VITE_YOUTUBE_API_KEY ? '✅ Set' : '❌ Missing'}</div>
        </div>
      </div>
