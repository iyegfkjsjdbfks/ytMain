...
const variantStyles: Record<ButtonVariant, string> = {
  primary: [
    ...
    'focus:ring-red-500',
    'active:bg-red-800'].join(' '),
          secondary: [
    'bg-neutral-100 text-neutral-900 border border-neutral-200',
    'hover:bg-neutral-200 hover:border-neutral-300',
    'focus:ring-neutral-500',
    'dark:bg-neutral-800 dark:text-neutral-100 dark:border-neutral-700',
    'dark:hover:bg-neutral-700 dark:hover:border-neutral-600'].join(' '),
          ghost: [
    'bg-transparent text-neutral-700 border border-transparent',
    'hover:bg-neutral-100 hover:text-neutral-900',
    'focus:ring-neutral-500',
    'dark:text-neutral-300 dark:hover:bg-neutral-800 dark:hover:text-neutral-100'].join(' '),
          danger: [
    'bg-red-600 text-white border border-red-600',
    'hover:bg-red-700 hover:border-red-700',
    'focus:ring-red-500',
