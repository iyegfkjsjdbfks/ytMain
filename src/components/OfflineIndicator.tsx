...
const OfflineIndicator: FC<OfflineIndicatorProps> = ({ className = '' }: any) => {
 ...
 return (
 <div
// FIXED:  className={`flex items-center space-x-1 text-green-600 dark:text-green-400 ${className}`} />
 >
...
// FIXED:  </div>
 ...
 <button />
// FIXED:  onClick={() => setShowDetails(!showDetails)}
// FIXED:  className='flex items-center space-x-1 text-orange-600 dark:text-orange-400 hover:text-orange-700 dark:hover:text-orange-300 transition-colors'
// FIXED:  aria-label='Offline mode details'
 >
...
// FIXED:  </h3>
 <button />
// FIXED:  onClick={() => setShowDetails(false)}
...
// FIXED:  </div>
 ...
 <div
// FIXED:  className='bg-blue-500 h-1.5 rounded-full transition-all duration-300'
// FIXED:  style={{
