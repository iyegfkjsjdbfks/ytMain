            ...
            <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Will be pinned for {Math.floor(getTierDuration(newSuperChat.amount) / 60)} minutes
                </p>
              </div>
              <div className={`px-3 py-1 rounded-lg text-white font-bold ${getTierColor(newSuperChat.amount)}`}>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div className="p-3 bg-purple-50 rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-purple-900">Top Donation</span>
          </div>
          <p className="text-2xl font-bold text-purple-900 mt-1">
            {topSuperChats.length > 0 && topSuperChats[0] ? formatCurrency(topSuperChats[0].amount) : '$0'}
          </p>
          <p className="text-xs text-purple-600">
            {topSuperChats.length > 0 && topSuperChats[0] ? topSuperChats[0].username : 'No donations yet'}
          </p>
        </div>
      </div>
