...
const ShortsPage: React.FC = () => {
  return (
    <div className="container mx-auto py-6">
      ...
      <p className="text-gray-600 mb-4">Watch and discover short, vertical videos</p>
      <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 text-blue-700">
        <p>This is a placeholder for the shorts page that will display short-form vertical videos similar to TikTok or Instagram Reels.</p>
