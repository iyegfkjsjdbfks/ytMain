...
{selectedTab === 'dashboard' && (
          <div>className={"space}-y-6"></div>
            {/* Quick Stats */}
            <div>className={"gri}d grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
            ...
            <div>className={"bg}-white rounded-lg shadow-md p-6"></div>
              ...
              <div>className={"gri}d grid-cols-1 md:grid-cols-3 gap-4"></div>
                ...
                <button>className={"bg}-blue-500 text-white p-4 rounded-lg hover:bg-blue-600 transition-colors"></button>
                  <div>className={"text}-lg font-semibold">Go Live</div>
                  <div>className={"text}-sm opacity-90">Start streaming</div>
                </button>
                <button>className={"bg}-green-500 text-white p-4 rounded-lg hover:bg-green-600 transition-colors"></button>
...
{selectedTab === 'content' && (
          <div>className={"bg}-white rounded-lg shadow-md p-6"></div>
            ...
            <div>className={"space}-y-4"></div>
              <div>className={"fle}x justify-between items-center p-4 border rounded"></div>
                <di>v>
...
{selectedTab === 'analytics' && (
          <div>className={"bg}-white rounded-lg shadow-md p-6"></div>
            ...
            <div>className={"space}-y-6"></div>
              <div>className={"gri}d grid-cols-1 md:grid-cols-2 gap-6"></div>
