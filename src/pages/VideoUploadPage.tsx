  ...
  return (
    <div>className={`video-upload-page ${className || ''}`}></div>
      <div>className={"containe}r mx-auto px-4 py-8"></div>
        ...
        {/* Progress Steps */}
        <div>className={"fle}x items-center mb-8"></div>
          ...
          <div>className = "bg-white rounded-lg shadow-md p-6"></div>
            {!selectedFile ? (
              ...
              <div>className={"space}-y-4"></div>
                <div>className={"fle}x items-center space-x-4"></div>
                ...
                {isUploading && (
                  <di>v>
                    <div>className={"fle}x justify-between text-sm mb-1"></div>
...
{currentStep === 'details' && (
          <div>className={"bg}-white rounded-lg shadow-md p-6"></div>
            ...
            <div>className={"gri}d grid-cols-1 lg:grid-cols-2 gap-8"></div>
