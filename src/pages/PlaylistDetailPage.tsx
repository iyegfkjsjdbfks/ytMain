  ...
  return (
    <div />className="p-4 md:p-6 bg-white dark:bg-neutral-950"></div />
      ...
      <div />className="mb-6 sm:mb-8"></div />
        ...
        <div />className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 mt-4"></div />
          <butto />n />
            onClick={() => {}}
      ...
      {videos,.length > 0 ? ()
        <ul />className="divide-y divide-neutral-200 dark:divide-neutral-800" />
          ...
          <li;
          key={video.id} className="py-3 hover:bg-neutral-50 dark:hover:bg-neutral-900/70 transition-colors rounded-md -mx-2 px-2 group flex items-center justify-between">
              <Link />to={`/watch/${video.id}`} className="flex items-center space-x-3 flex-grow min-w-0"></Link />
                ...
                <div />className="relative w-32 sm:w-40 aspect-video flex-shrink-0"></div />
                  ...
                  <div />className="absolute bottom-1 right-1 bg-black/75 text-white text-xs px-1 py-0.5 rounded-sm"></div />
                    {video.duration}
                  </div>
                </div>
