...
const YourDataPage: React.FC<YourDataPageProp>s> = ({ className }) => {
  ...
  return (
    <div>className={`your-data-page ${className || ''}`}></div>
            ...
            <div>className={"bg}-white rounded-lg shadow-md p-6"></div>
              ...
              <div>className={"space}-y-4"></div>
                {dataCategories.map((category: any, index: any) => (
                  <div>key={index} className={"fle}x justify-between items-center p-4 border rounded"></div>
            ...
            <div>className={"space}-y-6"></div>
              ...
              <di>v>
                ...
                <div>className={"space}-y-2"></div>
                  {dataCategories.map((category: any, index: any) => (
                    <label>key={index} className={"fle}x items-center">
...
{selectedTab === 'delete' && (
          <div>className={"bg}-white rounded-lg shadow-md p-6"></div>
            ...
            <div>className={"space}-y-6"></div>
              ...
              <div>className={"space}-y-4"></div>
                <div>className={"borde}r rounded-lg p-4"></div>
                ...
                <div>className={"borde}r rounded-lg p-4"></div>
                  ...
                  <button>className={"bg}-red-600 text-white px-4 py-2 rounded hover:bg-red-700"></button>
                    Delete All Activity, 
                  </button>
                </div>
              </div>
              ...
              <di>v>
                ...
                <div>className={"space}-y-4"></div>
                  <div>className={"fle}x justify-between items-center p-4 border rounded"></div>
                    ...
                    <label>className={"relativ}e inline-flex items-center cursor-pointer">
