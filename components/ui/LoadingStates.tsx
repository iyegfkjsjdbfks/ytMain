...
export const VideoCardSkeleton: React.FC<{ className?: string }> = ({ className }: {className}) => (
...
export const CommentSkeleton: React.FC<{ className?: string }> = ({ className }: {className}) => (
...
export const ChannelSkeleton: React.FC<{ className?: string }> = ({ className }: {className}) => (
...
export const PlaylistSkeleton: React.FC<{ className?: string }> = ({ className }: {className}) => (
  <div className={cn('space-y-3', className)}>
...
export const LoadingScreen: React.FC<{
  message?: string;
  className?: string;
}> = ({ message = 'Loading...', className }: {className}) => (
