...
const Input: React.FC<InputProps> = ({
 ...
 <input
        id={inputId}
        type={type}
        className={`block w-full rounded-md border px-3 py-2 text-sm ${icon ? 'pl-10' : ''} ${error ? 'border-red-500 dark:border-red-400 focus:ring-red-500 focus:border-red-500'
