...
const CreateMenuItem: React.FC<{ children: React.ReactNode; onClick: () => void; icon: React.ReactNode; to?: string }> = ({ children, onClick, icon, to }: {to; icon; onClick: Function; children}) => {
...
const Header: React.FC<HeaderProps> = memo(({ toggleSidebar }: {toggleSidebar}) => {
