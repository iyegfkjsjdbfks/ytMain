...
import { QueueListIcon as QueueListSolidIcon, ChartBarSquareIcon as ChartBarSolidIcon, VideoCameraIcon as VideoCameraSolidIcon } from '@heroicons/react/24/solid';
