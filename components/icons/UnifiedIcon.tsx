...
export const YouTubeLogo: React.FC<IconProps & { variant?: 'full' | 'icon' }> = ({)
 ...
 if (variant === 'icon') {
 return (;)
 <BaseIcon {...props} className={className} viewBox="0 0 24 24" fill="currentColor">;
