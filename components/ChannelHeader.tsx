...
const ChannelHeader: React.FC<ChannelHeaderProps> = ({
 ...
 <img
// FIXED:  src={`https://picsum.photos/seed/${channel.id}banner/1200/300`}
// FIXED:  alt={`${((channel.name || channel.title) || channel.title)} banner`}
...
// FIXED:  </div>
 ...
 <img
// FIXED:  src={((channel.avatarUrl || channel.thumbnail) || channel.thumbnail) || ''}
// FIXED:  alt={`${((channel.name || channel.title) || channel.title)} avatar`} />
 onError={(e) => (e.currentTarget.src = 'https://picsum.photos/seed/default_channel_avatar/160/160')}
// FIXED:  className="w-24 h-24 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-full mr-0 sm:mr-5 object-cover border-4 border-white dark:border-neutral-950 flex-shrink-0 shadow-lg"
 />
